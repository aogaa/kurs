...
- [~] Første kurs: **Kunnskapsprøven i alkoholloven – skjenkebevilling**
  ...
  - [x] **Fase 2 – de ni leksjonene** (9 av 9 skrevet, bygget og preview-verifisert).
  - [x] **Fase 2B – fordypning av leksjonene** (alle ni leksjoner utvidet med
        eksamensnær fordypning og kontrollert mot `alkoholloven.md` og
...
## 11. Arbeidsordre: Fase 2B – fordypning av leksjonene (utført)

Fase 2B ble lagt inn etter gjennomgang av alle kapitlene, fordi første versjon av
leksjonene var riktig strukturert, men for tynn til å være trygg alene før
kunnskapsprøven.

Utført arbeid:
- Alle ni leksjoner er utvidet med `## Fordypning før prøven`.
- Fordypningen dekker mer av pensumkravet i alkoholforskriften § 5-4:
  alkoholloven kapittel 1, 4, 5, 7, 8 og 9 samt relevante forskriftskapitler.
- Ekstra vekt er lagt på eksamensfeller: alkoholgrupper, roller, alderskontroll,
  skjenkeareal, åpenbart påvirkede personer, ambulerende bevilling,
  internkontroll, kontroll/prikker og reklameunntak.
- Alle juridiske tall, grenser og hovedregler er kontrollert mot
  `Skjenkebevilgning/kunnskapsbase/alkoholloven.md` og
  `Skjenkebevilgning/kunnskapsbase/alkoholforskriften.md`.

Neste fase er **Fase 3 – full spørsmålsbank ~120–150**, i godkjenningsbolker.
